...
import { AiOutlineTwitter, AiOutlineGithub, AiOutlineMedium } from 'react-icons/ai'
...
export default function footer() {
  ...
  <div>
    ...
    <p>Airbnb-experiences<br/>Zaid Tahir</p>
  </div> 
  <div>
    <span className="footer-title">Social</span> 
    <div className="grid grid-flow-col gap-4">
      <a href='https://twitter.com/zaidtahir_' target="_blank"><AiOutlineTwitter /></a> 
      <a href='https://github.com/zaidtahircodes'target="_blank" ><AiOutlineGithub/></a> 
      <a href='https://medium.com/@zaidtahir' target="_blank"><AiOutlineMedium /></a>
    </div>
  </div>
</footer>
    )
